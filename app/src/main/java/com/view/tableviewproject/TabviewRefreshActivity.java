...
import com.view.tableview.TableViewRefresh;
...
public class TabviewRefreshActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TableViewRefresh mLockTableView = new TableViewRefresh(this, mContentView, mTitleData, parentEntities);
        mLockTableView
            ...
            @Override
            public void onRefresh(PRecyclerView mPRecyclerView, ArrayList list) {

            }

            @Override
            public void onLoadMore(PRecyclerView mPRecyclerView, ArrayList list) {
