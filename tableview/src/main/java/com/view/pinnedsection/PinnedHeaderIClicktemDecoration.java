package com.view.pinnedsection;
...
import com.view.pinnedsection.callback.OnHeaderClickListener;
import com.view.pinnedsection.callback.OnItemTouchListener;
import com.view.pinnedsection.utils.DividerHelper;
 ...
 */
public class PinnedHeaderIClicktemDecoration extends RecyclerView.ItemDecoration {
    ...
    private PinnedHeaderIClicktemDecoration(Builder builder) {
    ...
    public static class Builder {
        ...
        public PinnedHeaderIClicktemDecoration create() {
            return new PinnedHeaderIClicktemDecoration(this);
        }
