package com.view.precyclerview;
...
public class PRecyclerView extends RecyclerView {
    ...
    public PRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PRecyclerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        public void onChanged() {
            ...
            if (mWrapAdapter != null && mEmptyView != null) {
                ...
                if (mWrapAdapter.getItemCount() == emptyCount) {
                    ...
                    PRecyclerView.this.setVisibility(View.GONE);
                } else {

                    mEmptyView.setVisibility(View.GONE);
                    PRecyclerView.this.setVisibility(View.VISIBLE);
                }
            }
        }
