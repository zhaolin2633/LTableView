...
public class TableView {
     ...
     * 表格主视图
     */
    private LinearLayout mTableScrollView;
    /**
     * 列表适配器
     */
    private TableViewContainer mTableViewAdapter;
     ...
     */
    public TableView(Context mContext, ViewGroup mContentView, ArrayList<String> mTableColumnDatas, ArrayList<ParentEntity> mTableDatas) {
    ...
    private void initAttrs() {
        mTableView = LayoutInflater.from(mContext).inflate(R.layout.tableview, null);
    ...
    private void initView() {
        ...
        mTableScrollView = (LinearLayout) mTableView.findViewById(R.id.table_scrollView);
        ...
        creatHeadView();
        mTableViewAdapter = new TableViewContainer(mContext, mTableDatas);
        ...
        mTableViewAdapter.setContentView();
        mTableScrollView.addView(mTableViewAdapter);
    }
    ...
    public TableView setTableViewListener(OnTableViewListener mTableViewListener) {
        this.mTableViewListener = mTableViewListener;
        return this;
    }

    public TableView setOnLoadingListener(OnLoadingListener mOnLoadingListener) {
        this.mOnLoadingListener = mOnLoadingListener;
        return this;
    }

    public TableView setTableViewRangeListener(OnTableViewRangeListener mTableViewRangeListener) {
        this.mTableViewRangeListener = mTableViewRangeListener;
        return this;
    }

    public TableView setOnItemClickListenter(OnItemClickListenter mOnItemClickListenter) {
        this.mOnItemClickListenter = mOnItemClickListenter;
        return this;
    }

    public TableView setOnItemLongClickListenter(OnItemLongClickListenter mOnItemLongClickListenter) {
        this.mOnItemLongClickListenter = mOnItemLongClickListenter;
        return this;
    }


    public TableView setViewAttribute(ViewAttribute mAttribute) {
